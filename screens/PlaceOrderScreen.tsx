...
interface PlaceOrderScreenProps {
  navigation: NativeStackNavigationProp<RootStackParamList, 'PlaceOrder'>;
  route: RouteProp<RootStackParamList, 'PlaceOrder'>;
}
...
const PlaceOrderScreen: React.FC<PlaceOrderScreenProps> = ({ navigation, route }) => {
  ...
  const updateQuantity = (menuId: number, delta: number): void => {
    setCart((prevCart) => {
